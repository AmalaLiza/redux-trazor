...
var ActionCreators = exports.ActionCreators = {
  ...
  commit: function commit(state) {
    return { type: ActionTypes.COMMIT, timestamp: Date.now(), state: state };
  },
      ...
      case ActionTypes.COMMIT:
        {
          ...
          stagedActionIds = [0];
          skippedActionIds = [];
          if (!liftedAction.state) committedState = computedStates[currentStateIndex].state;else committedState = liftedAction.state;
          currentStateIndex = 0;
          computedStates = [];
          break;
        }

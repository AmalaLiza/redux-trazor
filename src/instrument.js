...
export const ActionCreators = {
  ...
  commit: function commit(state) {
    return { type: ActionTypes.COMMIT, timestamp: Date.now(), state};
  },
  ...
  return (liftedState = initialLiftedState, liftedAction) => {
    ...
    switch (liftedAction.type) {
      ...
      case ActionTypes.COMMIT: {
          ...
          stagedActionIds = [0];
          skippedActionIds = [];
          if(!liftedAction.state) committedState = computedStates[currentStateIndex].state;
          else committedState = liftedAction.state;
          currentStateIndex = 0;
          computedStates = [];
          break;
      }
